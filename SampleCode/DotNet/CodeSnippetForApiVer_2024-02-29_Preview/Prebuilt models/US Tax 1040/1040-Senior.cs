...
/*
  This code sample shows Prebuilt US Tax 1040-Senior operations with the Document Intelligence SDKs. 
...
// sample document
Uri fileUri = new("https://documentintelligence.ai.azure.com/documents/samples/prebuilt/1040-Senior.pdf");

var content = new AnalyzeDocumentContent() { UrlSource = fileUri };

Operation<AnalyzeResult> operation = await client.AnalyzeDocumentAsync(WaitUntil.Completed, "prebuilt-tax.us.1040Senior", content);
