...
/*
  This code sample shows Prebuilt US Tax 1099-QA operations with the Document Intelligence SDKs. 
...
// sample document
Uri fileUri = new("https://documentintelligence.ai.azure.com/documents/samples/prebuilt/1099-QA.png");

var content = new AnalyzeDocumentContent() { UrlSource = fileUri };

Operation<AnalyzeResult> operation = await client.AnalyzeDocumentAsync(WaitUntil.Completed, "prebuilt-tax.us.1099QA", content);
