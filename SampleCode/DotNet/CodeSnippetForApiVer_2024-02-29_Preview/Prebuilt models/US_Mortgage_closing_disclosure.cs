...
/*
  This code sample shows Prebuilt US Mortgage closing disclosure operations with the Document Intelligence SDKs. 
...
// sample document
Uri fileUri = new("https://documentintelligence.ai.azure.com/documents/samples/prebuilt/mortgage-closing-disclosure.pdf");

var content = new AnalyzeDocumentContent() { UrlSource = fileUri };

Operation<AnalyzeResult> operation = await client.AnalyzeDocumentAsync(WaitUntil.Completed, "prebuilt-mortgage.us.closingDisclosure", content);
